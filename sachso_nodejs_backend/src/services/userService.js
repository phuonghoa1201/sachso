...
const handleLoginService = async (email, password) => {
    try {
        ...
        // fetch user by email- tim ng dung coi email có tồn tại ko
        ...
        if (user) {
            ...
            if (!isMatchPassword) {
                ...
                // gọi hàm sign(payload: data bạn muốn token chứa cái data, mã hóa (phần màu tím)), đặt mk coi tính bảo mật
